    ...
    @section('content')
        <form method="POST" id="editCate" action="{{route('cateEditSuccess',['id'=>$cate->category_id])}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="cate" value="{{$cate->name}}">
            </div>
            <div class="form-group">
                    <label for="description">คำอธิบาย</label>
                    <textarea class="form-control" id="description" rows="3" name="description">{{$cate->description}}</textarea>
                </div>
            <div class="form-group">
